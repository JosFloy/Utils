...
/**
 * Created by Jos on 2018/3/21 0021.
 * You can copy it everywhere that you need
 */
...
public class UpCircleMenuLayout extends ViewGroup {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            //计算menu item的尺寸和设置好的模式，对item进行测量
     ...
     * onTouchEvent是View中提供的方法，ViewGroup也有这个方法，
     * view中不提供onInterceptTouchEvent。view中默认返回true，表示消费了这个事件。
     **/
    @Override
