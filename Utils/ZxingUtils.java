...
public class ZxingUtils {
     ...
     *
     * @param context
     * @param contents      要生成的内容
     * @param desiredWidth  生成条形码的宽度
     * @param desiredHeight 生成条形码的高度
     * @param displayCode   是否在条形码下方显示的内容
     * @return
     */
    public static Bitmap createBarcode(Context context, String contents, int desiredWidth,
     ...
     * @param format        编码格式
     * @param desiredWidth  生成后的宽度
     * @param desiredHeight 图片生成的高度
     * @return 生成后的图片
     */
